...
!+------------------------------------------------------------+
SUBROUTINE init(u,Temp,Chem,t,dt,dt1,dt2,startstep,restarted)
...
! set initial state
  ...
  ELSE 
     ...
     ELSE
        ...
        dt =  dt_initial
     ENDIF
     CALL set_initial_condition(u,Temp,Chem)
  ENDIF
